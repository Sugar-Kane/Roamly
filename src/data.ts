...
export const THEMES: Theme[] = [
  ...
  {
    // Warm dark. Library Night is violet on blue-grey, which is still a cool
    // palette; this one drops the blue almost entirely for amber on warm
    // charcoal, which is what you want on a screen at 2am.
    id: "nightshift",
    name: "Night Shift",
    hint: "Warm amber, easy at 2am",
    premium: false,
    dark: true,
    ring: "#F7B645",
    rest: "#39C6B3",
    ...
    vars: {
      ...
      "--primary": "38 92% 62%",
      "--primary-foreground": "28 30% 12%",
      "--secondary": "28 10% 19%",
      "--secondary-foreground": "35 18% 88%",
      "--muted": "28 10% 19%",
      "--muted-foreground": "32 12% 66%",
      "--accent": "172 55% 50%",
      "--accent-foreground": "28 30% 12%",
      "--border": "28 10% 23%",
      "--input": "28 10% 23%",
      "--ring": "38 92% 62%",
      "--roamly-purple": "38 92% 62%",
      "--roamly-coral": "14 80% 62%",
      "--roamly-blue": "172 55% 50%",
      "--roamly-green": "152 50% 50%",
    },
  },
  {
    // The dark counterpart to Ocean Desk — same sea palette, pulled underwater.
    id: "deepsea",
    name: "Deep Sea",
    hint: "Cool teal in the dark",
    premium: false,
    dark: true,
    ring: "#42DBF0",
    rest: "#25D0A5",
    ...
    vars: {
      ...
      "--secondary": "205 25% 18%",
      "--secondary-foreground": "195 20% 88%",
      "--muted": "205 25% 18%",
      "--muted-foreground": "200 14% 66%",
      "--accent": "165 70% 48%",
      "--accent-foreground": "205 35% 8%",
      "--border": "205 22% 22%",
      "--input": "205 22% 22%",
      "--ring": "187 85% 60%",
      "--roamly-purple": "187 85% 60%",
      "--roamly-coral": "8 75% 62%",
      "--roamly-blue": "200 90% 62%",
      "--roamly-green": "165 70% 48%",
    },
  },
  {
    id: "sage",
