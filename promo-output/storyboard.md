...
**Revision 3 (client direction): the Rooms beat is cut to the VO word by word, with taped callout notes that name each part of the feature.**
...
| 13 | 33.00–35.60 | **Rooms lobby** | Page-turn into the real **Rooms** lobby: ALWAYS-ON ROOMS (The Grind Hall, **Deep Work Hall**, Sprint Studio, Marathon Library) with live focus timers and occupancy. A taped note: *"real students, studying live"*. **Join** is tapped on Deep Work Hall on the VO word "Join" (35.2), 7/50 → 8/50. | Page turns, pencil, tap | 33.04 "And you don't have to do it alone. Join a study room." |
| 14a | 35.60–40.85 | **Study together** | In **Deep Work Hall**: FOCUS · BLOCK 2/3, the shared timer at 31:08, "Everyone in this room sees the same timer." Eight members pop in. On "Everyone" an amber ring circles the group; on "one timer" the digits pulse and a note reads *"one timer for everyone ↑"*. On "chat" (39.2) the **Break-time chat** card lands, locked ("Opens at break · 31:0x"), with the note *"chat stays locked while you focus ↓"*. The shared timer time-lapses under "only opens on the…" | Pop per member, pencil ring, pencil notes, sheet, riser | 36.67 "Everyone shares one timer, and chat only opens on the break." |
| 14b | 40.85–45.30 | **Break together** | On the word "break", everyone hits SHORT BREAK · BLOCK 2/3 together (green), with confetti. The chat card flashes green and unlocks ("Open, it's break time"). Note: *"break = chat time ✓"*. The messages land on the VO words: maya.r on "hi", sofia_l on "notes", priya "see you all next block" on "next block". At 44.85 the room shrinks into the phone on the desk. | Chime, confetti, a ping per message | 41.52 "Say hi, compare notes, then start the next block together." |
| 14c | 45.30–50.00 | **Same desk** | The desk, now organized: slides stacked (Lecture 12 stamped ✓), flashcards squared, and the same calendar with the exam still circled. The phone runs Focus mode; Analytics shows Today **75 / 120 min** and a **1-day streak**. The opening thoughts get rewritten: "start here ↓", "1 of 5 done ✓", "75 min. on purpose." | Pencil rewrites, tape, paper settles | 46.14 "Same workload. Better way through it." |
